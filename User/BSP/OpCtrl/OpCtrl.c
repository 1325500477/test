...
<<<<<<< HEAD
		...
		dm_ctrl_one(DM_WARM_CONTROL, RELAY_OFF);			//热压升起
		dm_ctrl_one(DM_COOL_CONTROL, RELAY_OFF);			//冷压升起
		dm_ctrl_one(DM_PRES_CONTROL, RELAY_OFF);			//剪切升起
		dm_ctrl_one(DM_ALL_CONTROL, RELAY_OFF);  			//液压关闭
