 ...
 * Chip type           : ATMEGA128 with ENC28J60
 *********************************************/
#include <string.h>
#include <stdio.h>
...
static unsigned int gNextPacketPtr;
...
unsigned char enc28j60hasRxPkt(void)
{
...
unsigned int enc28j60PacketReceive(unsigned int maxlen, unsigned char* packet)
{
	...
	rxstat |= ((unsigned int)enc28j60ReadOp(ENC28J60_READ_BUF_MEM, 0))<<8;
