...
enum ENUM_LIFT_HORIZON_LOCATION 		//电梯小车水平位置
{
    ...
    ENUM_LIFT_HORIZON_REC_AND_SEND,	    //1接送卡位 			   		   
...
enum ENUM_STATION_HAVE_CARD_INDEX
{
	...
	STATION_HOT_PRESS_OUT_SENSOR_HAS_CARD,			//2出热压传感器检测有卡
	STATION_COLD_PRESS_OUT_SENSOR_HAS_CARD,			//3出冷压传感器检测有卡
	STATION_LIFT_SUCK_HAS_CARD,						//4电梯吸盘处吸住了卡
	STATION_LIFT_MID_HAS_CARD,						//5电梯有卡
	STATION_OUT_PORT_HAS_CARD,						//6出卡通道有卡
	STATION_RECYCLE_BOX_FULL,						//7回收箱满
	STATION_RECYCLE_BOX_IN_PLACE,					//8回收箱到位
	STATION_RECYCLE_BOX_HAS_CARD,					//9回收箱有卡
	//...............
